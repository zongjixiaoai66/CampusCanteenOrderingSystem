...
// 注：这里如果用缓冲方式写入文件的话，会导致中文乱码，用flush()方法则可以避免
    ...
    public R barSumOne(@RequestParam Map<String,Object> params, HttpServletRequest request) {
    ...
    public R barCountOne(@RequestParam Map<String,Object> params, HttpServletRequest request) {
