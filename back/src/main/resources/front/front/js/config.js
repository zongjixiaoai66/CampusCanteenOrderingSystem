...
var centerMenu = [
    ...
    ,{
        name: '美食评价',
        url: '../meishiCommentback/list.html'
    }
    ,{
        name: '美食订单',
...
var indexNav = [
    ...
    {
        name: '食堂',
        url: './pages/shitang/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanshitangdingcan/admin/dist/index.html#/login";
